...
# Segerfeldt.EventStore.PostgreSQL

A NuGet package for implementing the Command/Write-Model side of a CQRS application using PostgreSQL.

Add Segerfeldt.EventStore.Projection.PostgreSQL to another project to sync the state to a Query/Read-Model database.

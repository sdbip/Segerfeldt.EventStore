...
public static class ServiceCollectionExtension
{
    ...
    public static EventSourceConfigurationWithoutTarget AddHostedPostgreSQLEventSource(this IServiceCollection services, string name, string connectionString, EventSourceOptions? options = null) =>
    ...
    /// <returns>An <see cref="EventSourceConfiguration"/> for allowing additional configuration</returns>
    public static EventSourceConfigurationWithoutTarget AddHostedPostgreSQLEventSource(this IServiceCollection services, string name, NpgsqlConnection connection, EventSourceOptions? options = null) =>
        services.AddHostedPostgreSQLEventSource(name, (p, n) => connection, options);

    private static EventSourceConfigurationWithoutTarget AddHostedPostgreSQLEventSource(this IServiceCollection services, string name, Func<IServiceProvider, object, IDbConnection> connectionFunc, EventSourceOptions? options)
    {

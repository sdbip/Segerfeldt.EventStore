...
public static class ServiceCollectionExtension
{
    ...
    public static EventSourceConfiguration AddHostedSQLServerEventSource(this IServiceCollection services, string name, string connectionString, EventSourceOptions? options = null) =>
    ...
    /// <returns>An <see cref="EventSourceConfiguration"/> for allowing additional configuration</returns>
    public static EventSourceConfiguration AddHostedSQLServerEventSource(this IServiceCollection services, string name, SqlConnection connection, EventSourceOptions? options = null) =>
        services.AddHostedSQLServerEventSource(name, (p, n) => connection, options);

    private static EventSourceConfiguration AddHostedSQLServerEventSource(this IServiceCollection services, string name, Func<IServiceProvider, object, IDbConnection> connectionFunc, EventSourceOptions? options)
    {

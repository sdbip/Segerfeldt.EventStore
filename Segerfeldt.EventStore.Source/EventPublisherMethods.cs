...
namespace Segerfeldt.EventStore.Source
{
    public static class EventPublisherMethods
    {
        ...
        public static UpdatedStorePosition Publish(this IEventPublisher eventPublisher, EntityId entityId, EntityType type, UnpublishedEvent @event, string actor) =>
        ...
        public static UpdatedStorePosition PublishChanges(this IEventPublisher eventPublisher, IEntity entity, string actor) =>
        ...
        /// <param name="entity">the entity whose events to publish</param>
        /// <param name="actor">the actor/user who caused these changes</param>
        public static async Task<UpdatedStorePosition> PublishChangesAsync(this IEventPublisher eventPublisher, IEntity entity, string actor) =>
        ...
        /// <param name="actor">the actor/user who caused these changes</param>
        public static UpdatedStorePosition PublishChanges(this IEventPublisher eventPublisher, IEnumerable<IEntity> entities, string actor) =>

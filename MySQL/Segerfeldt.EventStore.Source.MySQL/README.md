...
Add Segerfeldt.EventStore.Projection.MySQL to another project to sync the state to a Query/Read-Model database.
...
```csharp
builder.Services.UseMySQLEventStore(builder.Configuration.GetConnectionString("main")!);
```
